#!/usr/bin/env node
/**
 * Ports the 8 posts from ../palia-blog into src/data/forum/posts.generated.ts
...
const SOURCE_DIR = join(ROOT, '..', 'palia-blog', 'src', 'content', 'posts');
...
for (const file of POST_FILES) {
	...
	sources.push({
		...
		intro: post.excerpt,
		keywords: [...post.tags, 'palia intel'],
...
const file = `/* Auto-generated by scripts/port-from-palia-blog.mjs — do not edit by hand. */
